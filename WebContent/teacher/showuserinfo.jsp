		...
		<s:if test="#request['teacher']!=null">
			<fieldset>
				...
				<s:form cssStyle="color:blue;">
					<s:textfield label="教师编号" value="%{#request['teacher']['teacherId']}"
						readonly="true"></s:textfield>
					<s:textfield label="姓名" value="%{#request['teacher']['teacherName']}"
						readonly="true"></s:textfield>
					<s:textfield label="性别" value="%{#request['teacher']['teacherSex']}"
						readonly="true"></s:textfield>
		...
		<s:else>
			<fieldset>
				...
				<s:form cssStyle="color:blue;">
					...
					<s:textfield label="所在院系"
						value="%{#request['student']['department']['departmentName']}"></s:textfield>
					<s:textfield label="专业"
						value="%{#request['student']['discipline']['disciplineName']}"></s:textfield>
				</s:form>
			</fieldset>
		</s:else>
	</div>
