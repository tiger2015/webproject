...
public class FindResponse extends ActionSupport implements ServletRequestAware{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6863373556484094098L;
    ...
    public String findResponse()
    {
    	...
    	List message=new MessageDAO().findAllByProperty("messageId", messageId,null);
    	List response=new ResponseDAO().findByProperty("messageId",messageId,splitePage);
